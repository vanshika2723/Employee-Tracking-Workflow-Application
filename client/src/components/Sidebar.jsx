...
<div className="flex items-center justify-between">
    <div className="flex items-center gap-3">
        ...
        <p className="text-[11px] text-slate-500 font-medium">Workflow Tracking Application</p>
    </div>
...
<span className="text-xs">Loading...</span>
 ...
 navItems.map((item)=>{
        ...
        return ( 
            ...
            <item.icon className={`w-[17px] h-[17px] shrink-0 ${isActive ? "text-indigo-300": "tsxt-slate-400 group-hover:text-slate-300"}`}/>
...
>
    <LogOutIcon className="w-[17px] w-[17px]"/>
    <span>Log Out</span>
</button>
</div>
        </>
