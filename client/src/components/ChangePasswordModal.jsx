...
const ChangePasswordModal=({open , onClose})=>{
    ...
    return(
        ...
        className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md aimate-fade-in" onClick={(e)=>e.stopPropagation()}>
                <div className="flex items-center justify-between p-6 pb-0">
                    <h2 className="test-lg font-medium test-slate-900 flex items-center gap-2">
